...
public class BaseTest {
	...
	@Description("init the driver and peroperties")
	@Parameters({"browser"})
	@BeforeTest
...
//		LogUtil.info("-----------starting the test case------------"+ result.getName());
//	}
...
//		log.info("-----------ending the test case------------"+ result.getMethod().getMethodName());
